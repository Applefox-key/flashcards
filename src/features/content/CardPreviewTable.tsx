  ...
  return (
    <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
      <div className="grid grid-cols-[1fr_1fr_1fr_2rem] gap-0 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-3 py-2">
        <span className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("card_preview_table.col_question")}</span>
        <span className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("card_preview_table.col_answer")}</span>
        <span className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("card_preview_table.col_note")}</span>
        <span />
      </div>
        ...
        {cards.map((card) => (
          <div key={card.id} className="grid grid-cols-[1fr_1fr_1fr_2rem] gap-1 px-3 py-1.5 items-center bg-white dark:bg-gray-800">
            ...
            <input
              ...
              placeholder={t("card_preview_table.note_placeholder")}
            ...
            <button
              ...
              title={t("card_preview_table.remove_btn")}>
              ×
            </button>
          </div>
        ))}
