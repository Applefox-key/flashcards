...
export function CollectionEditPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    editCollection.mutate(
      ...
      {
        onSuccess: () => {
          setCollectionTags.mutate({ collectionId: colId, tagIds }, {
            onSuccess: () => {
      ...
      <div className="mt-6 bg-white rounded-lg border border-red-200 p-5">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <Button variant="danger" size="sm" onClick={handleDeleteAllCards} loading={deleteAllCards.isPending} type="button">
              Delete cards
            </Button>
          </div>
